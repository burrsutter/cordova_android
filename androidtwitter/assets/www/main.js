...
$('#page-home').live('pageinit', function() {
    ...
    var options = { 
            ...
            callbackUrl: 'http://statushandler-burrsutter.rhcloud.com/TestServlet' };
            // callbackURL points to a public URL that I have control over - use your own :-)
    var mentionsId = 0;
    ...
    $('#startbutton').click(function() {       
        ...
        if (typeof window.plugins.childBrowser.onLocationChange !== "function") {
            window.plugins.childBrowser.onLocationChange = function(loc){
                ...
                if (loc.indexOf("http://statushandler-burrsutter.rhcloud.com/TestServlet?denied") >= 0) {
                ...
                if (loc === "http://www.burrsutter.com/") {
                    $('#oauthStatus').html('<span style="color:red;">User declined access</span>');
                    return;
                }
                
                // The supplied oauth_callback_url for this session is being loaded
                if (loc.indexOf("http://statushandler-burrsutter.rhcloud.com/TestServlet?") >= 0) {
                    var index, verifier = '';            
